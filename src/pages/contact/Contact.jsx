        ...
        <div className="w-[60%] h-full border-[1px] border-[#1d2221] px-6 py-4 gap-6 flex flex-col rounded-lg bg-[#111716]">
           ...
           <form action="" className="flex flex-col gap-8 justify-between h-full " onSubmit={handleSubmit}>
              <div className="w-full shrink-0 relative ">
                <input type="text" placeholder="Your Name *" onChange={(elem)=>{ setMessage({...message, name : elem.target.value}); }} value={message.name} className={`w-full  border  rounded-lg  ${nameErr? ' border-[#c33434] focus:border-[#c33434] hover:border-[#c33434]' : ' border-[#272928] hover:border-[#10b98140] focus:border-[#10b98140]'} transition-all duration-300 outline-none px-[1vw] py-[0.7vw] text-[1.2vw] bg-[#1e2020] text-[#d4d4d8] placeholder:text-[#9e9e9e]`}/>
                {nameErr?(<p className="text-[#c33434] text-[1.1vw] absolute top-[102%] left-[0.3vw]">Name is required</p>) :''}  
              </div>
              
              <div className="w-full shrink-0 relative ">
                <input type="email" placeholder="Your Email *" onChange={(elem)=>{ setMessage({...message, email : elem.target.value})}} value={message.email}  className={`w-full  border  rounded-lg  ${emailErr? ' border-[#c33434] focus:border-[#c33434] hover:border-[#c33434]' : ' border-[#272928] hover:border-[#10b98140] focus:border-[#10b98140]'} transition-all duration-300 outline-none px-[1vw] py-[0.7vw] text-[1.2vw] bg-[#1e2020] text-[#d4d4d8] placeholder:text-[#9e9e9e]`} />
                {emailErr?(<p className="text-[#c33434] text-[1.1vw] absolute top-[102%] left-[0.3vw]">Email is required</p>) :''}
              </div>

              <div className="w-full h-full relative">
                <textarea name="your-message" placeholder="Your Message *" onChange={(elem)=>{setMessage({...message, message : elem.target.value})}} value={message.message}  className={`w-full h-full resize-none  border  rounded-lg  ${messageErr? ' border-[#c33434] focus:border-[#c33434] hover:border-[#c33434]' : ' border-[#272928] hover:border-[#10b98140] focus:border-[#10b98140]'} transition-all duration-300 outline-none px-[1vw] py-[0.7vw] text-[1.2vw] bg-[#1e2020] text-[#d4d4d8] placeholder:text-[#9e9e9e]`}></textarea>
                {messageErr?(<p className="text-[#c33434] text-[1.1vw] absolute top-[102%] left-[0.3vw]">Message is required</p>) :''}
              </div>

              <button className={`${loading ? 'pointer-events-none' : 'pointer-events-auto' } select-none relative w-max px-[1vw] py-[1vw] overflow-hidden border rounded-lg border-[#272928] text-[#9e9e9e]  hover:border-[#10b74d] hover:text-[#10b74d] transition-all duration-300 bg-[#1e2020] cursor-pointer`}>
                 ...
                 <div className="absolute h-full  top-0 left-[-45%] shadowAnimation "></div>
              </button>
           </form>
        </div>
